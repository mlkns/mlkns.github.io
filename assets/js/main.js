(function() {
  ...
  function initSwiper() {
    document.querySelectorAll(".init-swiper").forEach(function(swiperElement) {
      ...
      // Add loop and autoplay options
      config.loop = true; // Looping slides
      config.autoplay = {
  ...
  function changeMessage() {
    const messages = [
        "Selamat ulang tahun! Semoga hari ini sangat istimewa!",
        "Wishing you a day filled with love and joy. Happy Birthday!",
        "Happy Birthday! May all your dreams come true today!",
        "Sending you lots of love and birthday wishes!",
        "Hope you have a fantastic birthday and a wonderful year ahead!"
    ];
